		...
		<>
			<header
                ...
                ${pathname === "/products" ? "bg-primary" : ""}`}>
					...
					<Link href={"/companies"} className={`flex items-center gap-4 p-4  rounded-xl hover:bg-tertiaryDark
                ${pathname === "/companies" ? "bg-primary" : ""}`}>
						<svg width="33" height="33" viewBox="0 0 33 33" fill="none" xmlns="http://www.w3.org/2000/svg">
							<path
				...
				<div className="flex flex-col gap-4">
					<button className="flex gap-2 hover:text-tertiaryDark" onClick={openPopup}>
					...
					<button className="flex gap-2 hover:text-tertiaryDark" onClick={logout} >
